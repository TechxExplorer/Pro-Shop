...
const products = [
  ...
  },
  {
    ...
    description:
      'A transformative triple-camera system that adds tons of capability without complexity. An unprecedented leap in battery life. And a chip that’s so fast, it blows past other smartphone chips.',
    brand: 'Apple',
    category: 'Electronics',
    price: 599.99,
    countInStock: 7,
